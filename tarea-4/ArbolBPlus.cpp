...
void ArbolBPlus::inicializar()
{
    raiz = new NodoBPlus(orden);
    raiz->llaves = new int[orden];
    raiz->datos = new Registro * [orden];
    principio = final = raiz;
}

int ArbolBPlus::getOrden()
{
    return this->orden;
}
...
void ArbolBPlus::agregar_en_nodo_no_lleno(NodoBPlus* n, int k, int i, Registro* r)
{
...
void ArbolBPlus::agregar_en_nodo_lleno(NodoBPlus* n, int k, int i, Registro* r)
{
    NodoBPlus* p, * n_s;
    int k_s;
    bool parar;
...
void ArbolBPlus::agregar_y_partir_raiz(NodoBPlus* n, int k, int i, Registro* r)
{
    //En copia se inserta el nuevo registro, pero toca dividir ya que esta en orden +1
    NodoBPlus* copia = new NodoBPlus;
    ...
    NodoBPlus* hermano = new NodoBPlus;
    ...
    NodoBPlus* nueva_raiz = new NodoBPlus;
    nueva_raiz->es_hoja = false;
    nueva_raiz->llaves = new int[orden];
    nueva_raiz->hijos = new NodoBPlus * [orden + 1];
...
bool ArbolBPlus::agregar_y_partir_hoja(NodoBPlus* n, int k, int i, Registro* r, NodoBPlus*& n_s, int& k_s)
{
    NodoBPlus* p = n->padre;
...
bool ArbolBPlus::agregar_y_partir_intermedio(NodoBPlus* n, NodoBPlus*& n_s, int& k_s)
{
    NodoBPlus* p = n->padre;
    int i_padre;
    ...
    copia->cuantas_llaves = orden;
    copia->llaves = new int[orden + 1];
    copia->hijos = new NodoBPlus * [orden + 2];
    ...
    hermano->llaves = new int[orden];
    hermano->hijos = new NodoBPlus * [orden + 1];
...
NodoBPlus* ArbolBPlus::buscar_hoja(NodoBPlus* n, int k)
{
    int i;
