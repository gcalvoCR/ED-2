...
public:
	...
	bool agregar(int); // agregar un numero en el arbol b
	void agregarEnLista(Casilla*);//agrega una casilla en la lista del arbol b
	string pintarArbol();//Para probar el arbol, ponerlo mas bonito despues
	string pintar();///pinta la lista de numeros ordenados
